...
def detect_pose_and_count_arm_movements(video_path, output_path):
    ...
    for _ in tqdm(range(total_frames), desc="Processando vídeo"):
        ...
        if results.pose_landmarks:
            ...
            if is_knee_up(results.pose_landmarks.landmark):
                if not arm_up:
                    arm_up = True
...
input_video_path = os.path.join(script_dir,'../../data','moving.mp4')  # Nome do vídeo de entrada
output_video_path = os.path.join(script_dir,'../../data','output_video_arm_up.mp4')  # Nome do vídeo de saída
